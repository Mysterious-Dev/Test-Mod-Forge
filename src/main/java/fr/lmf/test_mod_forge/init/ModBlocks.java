...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> TEST_SIMPLE_BLOCK = registerBlock("test_simple_block", ()-> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(10f, 10f).requiresCorrectToolForDrops()), new Item.Properties());
    public static final RegistryObject<Block> TEST_BLOCKSTATE_BLOCK = registerBlock("test_blockstate_block", ()-> new TestBlockStateBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(10f, 10f).requiresCorrectToolForDrops()), new Item.Properties());
