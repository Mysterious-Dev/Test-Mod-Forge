...
public class ModItems {
    ...
    public static final RegistryObject<Item> TEST_PICKAXE = ITEMS.register("test_pickaxe", ()-> new PickaxeItem(ModTiers.TEST_TIER, 1, -2.8F, new Item.Properties()));
    public static final RegistryObject<Item> TEST_TOOL = ITEMS.register("test_tool", ()-> new TestToolItem( 1, -2.8F, Tiers.DIAMOND, new Item.Properties()));
    public static final RegistryObject<Item> ANIMATED_ITEM_INTERPOLATED = ITEMS.register("animated_item_interpolated", ()-> new Item(new Item.Properties()));
    public static final RegistryObject<Item> ANIMATED_ITEM = ITEMS.register("animated_item", ()-> new Item(new Item.Properties()));
    public static final RegistryObject<Item> PROPERTY_ITEM = ITEMS.register("property_item", ()-> new Item(new Item.Properties()));
