    ...
    protected void registerModels() {
        ...
        withExistingParent(ModItems.SEPARATE_PERSPECTIVE.getId().getPath(), "forge:item/default")
                .customLoader(SeparateTransformsModelBuilder::begin)
                    ...
                    .perspective(ItemDisplayContext.GUI, nested().parent(getExistingFile(mcLoc("item/snowball"))))
                    .perspective(ItemDisplayContext.FIXED, nested().parent(getExistingFile(mcLoc("item/diamond"))))
                .end();
