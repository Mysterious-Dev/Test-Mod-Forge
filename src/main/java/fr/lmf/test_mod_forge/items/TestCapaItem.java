...
public class TestCapaItem extends Item {
    ...
    public void appendHoverText(ItemStack p_41421_, @Nullable Level p_41422_, List<Component> p_41423_, TooltipFlag p_41424_) {
        ...
        if(Minecraft.getInstance().player != null)
            Minecraft.getInstance().player.getCapability(TestCapability.POWER_CAPABILITY).ifPresent(cap -> p_41423_.add(Component.translatable("tooltip.test_mod_forge.power", cap.getPower())));
    }
}
